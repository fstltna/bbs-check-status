...
At our last scan of your BBS we could not connect to it. You may want to look into it or disable notifications if you don't want to get these messages in the future.
...
my $sth = $dbh->prepare("SELECT id, partner_url, field1, field2, field11 FROM $DB_Table");
